<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCComboUnidadeFederativa.ascx.cs" Inherits="Autenticador.UserControlLibrary.Combos.UCComboUnidadeFederativa" %>
...
<asp:ObjectDataSource ID="_odsCombo" runat="server" DataObjectTypeName="Autenticador.Entities.END_UnidadeFederativa"
    SelectMethod="GetSelect" TypeName="Autenticador.BLL.END_UnidadeFederativaBO"
