...
<fieldset>
    ...
    <div id="divSenha" runat="server" class="senha">
...
<fieldset>
    ...
    <asp:ObjectDataSource ID="odsGrupos" runat="server" DataObjectTypeName="Autenticador.Entities.SYS_Grupo"
        DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}" SelectMethod="GetSelectBy_MeusDados"
        TypeName="Autenticador.BLL.SYS_GrupoBO" UpdateMethod="Save" EnablePaging="True"
