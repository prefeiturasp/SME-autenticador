<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCFrequenciaServico.ascx.cs" Inherits="AutenticadorWebSite.WebControls.FrequenciaServico.UCFrequenciaServico" %>
...
<div id="divIntervaloMinutos" runat="server">
    <asp:Label ID="Label1" runat="server" Text="Minutos de intervalo *" AssociatedControlID="txtMinutoIntervalo"></asp:Label>
