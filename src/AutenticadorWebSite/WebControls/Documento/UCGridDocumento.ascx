<%@ Control Language="C#" AutoEventWireup="true" Inherits="WebControls_PessoaDocumento_UCGridPessoaDocumento"
    CodeBehind="UCGridDocumento.ascx.cs" %>
<asp:UpdatePanel ID="updGridDocumentos" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <fieldset>
                ...
                <ItemTemplate>
                    <div class="linha-documento">
                        ...
                        <div id="NumDoc" runat="server" class="div-input-inline">
                            ...
                            <asp:TextBox ID="tbNumDoc" runat="server" SkinID="text10C" MaxLength="50" Text='<%# Bind("numero") %>'></asp:TextBox>
                        </div>
                        ...
                        <div id="DtEmissao" runat="server" class="div-input-inline">
                            ...
                            <asp:TextBox ID="tbDtEmissao" runat="server" Width="115" CssClass="mskData" Text='<%# Bind("dataemissao") %>'></asp:TextBox>
                        </div>
                        ...
                        <div id="DataEntrada" runat="server" class="div-input-inline">
                            ...
                            <asp:TextBox ID="tbDataEntrada" runat="server" Width="115" CssClass="mskData" MaxLength="1000" Text='<%# Bind("dataEntrada") %>'></asp:TextBox>
                        </div>
                        ...
                        <div id="DataExpedicao" runat="server" class="div-input-inline">
                            ...
                            <asp:TextBox ID="tbDataExpedicao" runat="server" Width="115" CssClass="mskData" Text='<%# Bind("dataexpedicao") %>'></asp:TextBox>
                        </div>
                        ...
                        <div id="DataValidade" runat="server" class="div-input-inline">
                            ...
                            <asp:TextBox ID="tbDataValidade" runat="server" Width="115" CssClass="mskData" MaxLength="1000" Text='<%# Bind("dataValidade") %>'></asp:TextBox>
                        </div>
                        ...
                        <div id="UF" runat="server" class="div-input-inline">
                            ...
                            <asp:DropDownList ID="ddlUF" runat="server" AppendDataBoundItems="True" DataSourceID="odsUF"
                                DataTextField="unf_nome" DataValueField="unf_id" SkinID="text20C">
                        ...
                        <div id="Pais" runat="server" class="div-input-inline">
                            ...
                            <asp:DropDownList ID="ddlPais" runat="server" AppendDataBoundItems="True" DataSourceID="odsPais"
                                DataTextField="pai_nome" DataValueField="pai_id" SkinID="text20C">
            ...
            <asp:ObjectDataSource ID="odsTipoDocumentacao" runat="server" DataObjectTypeName="Autenticador.Entities.SYS_TipoDocumentacao"
                DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}" SelectMethod="GetSelect"
                TypeName="Autenticador.BLL.SYS_TipoDocumentacaoBO" UpdateMethod="Save">
                <SelectParameters>
            ...
            <asp:ObjectDataSource ID="odsPais" runat="server" DataObjectTypeName="Autenticador.Entities.END_Pais"
                DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}" SelectMethod="GetSelect"
                TypeName="Autenticador.BLL.END_PaisBO" UpdateMethod="Save">
                <DeleteParameters>
                    <asp:Parameter Name="entity" Type="Object" />
                    <asp:Parameter Name="banco" Type="Object" />
                </DeleteParameters>
