    ...
    $(function() {
        $(".tbCidadeCertidao_incremental").unbind('autocomplete').autocomplete({
            ...
            select: function(event, ui) {
                $(".tbCid_idCertidao_incremental").attr('value', ui.item.cid_id);
                $(".tbCidadeCertidao_incremental").attr('value', ui.item.cid_nome);
            },
            change: function(event, ui) {
                if (!ui.item) {
                    $(".tbCid_idCertidao_incremental").attr('value', "00000000-0000-0000-0000-000000000000");
                    $(".tbCidadeCertidao_incremental").attr('value', "");
                }
            }
        });
    })
