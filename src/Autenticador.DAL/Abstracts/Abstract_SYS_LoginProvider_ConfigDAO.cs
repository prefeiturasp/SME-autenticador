...
namespace Autenticador.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de SYS_LoginProvider_Config.
	/// </summary>
	public abstract class Abstract_SYS_LoginProvider_ConfigDAO : Abstract_DAL<SYS_LoginProvider_Config>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, SYS_LoginProvider_Config entity)
		{
			...
			Param.Size = 1024;
			Param.Value = entity.ClientId;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.AnsiString;
			Param.ParameterName = "@ClientSecret";
			Param.Size = 1024;
			Param.Value = entity.ClientSecret;
			qs.Parameters.Add(Param);
